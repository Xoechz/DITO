...
module github.com/Xoechz/DITO/src/ditoCollector

go 1.25.0

require (
	github.com/Xoechz/DITO/src/ditoConnector v0.143.0
...
replace github.com/Xoechz/DITO/src/ditoConnector => ../ditoConnector
