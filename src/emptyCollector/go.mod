...
module github.com/Xoechz/DITO/src/emptyCollector

go 1.25.0

require (
	github.com/Xoechz/DITO/src/emptyConnector v0.143.0
...
replace github.com/Xoechz/DITO/src/emptyConnector => ../emptyConnector
