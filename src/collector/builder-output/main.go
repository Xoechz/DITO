...
// Program otelcol-dito is an OpenTelemetry Collector binary.
package main
...
func main() {
	info := component.BuildInfo{
		...
		Description: "DITO groups traces of data points traveling trough a system together to better understand dataflows.",
		Version:     "0.0.1",
	}
