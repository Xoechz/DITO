...
OpenTelemetry has established itself as a groundbreaking new standard in the field of observability~\citebooks{Young2024/0; , Young2021/0}.
...
While OpenTelemetry was initially designed with microservices in mind, its applicability extends far beyond that~\citebook{Boten2022}{0}.
Distributed systems of all kinds, including legacy systems, can benefit significantly from its capabilities~\citebook{Gomez_Blanco2023}{0}.

\section{Problem}
\label{sec:i_problem}

A major challenge in legacy systems, especially those that have evolved organically over time,
is the absence of a single source of truth~\citebook{Flanders2024}{0}.
...
Traces, which are mostly underutilized, offer a more structured and insightful alternative~\citebook{Young2021}{0}.
