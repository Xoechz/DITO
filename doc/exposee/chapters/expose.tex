...
Traces, which are mostly underutilized, offer a more structured and insightful alternative~\cite{Young2021}.
...
The custom collector developed in this thesis will intercept traces, extract spans based on data point identifiers,
...
\begin{itemize}
    ...
    \item \textbf{GO (Golang):} Used to develop a custom OpenTelemetry collector that processes, filters, and reorganizes traces.
\end{itemize}
...
A custom OpenTelemetry collector will be developed in Go.
This collector will:
